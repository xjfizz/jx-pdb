	...
	<view class="widthAuto">
		...
		<view class="widthAutoInner">
			...
			<view class="vip-lb">
				...
				<view class="vip-lb-da"><input disabled class="vip-lb-input uni-input" cursor-spacing = "10" type="number" value="" placeholder="输入手机号" v-model="retUserPhone" /></view>
			</view>
			<view class="vip-lb">
			...
			<view class="vip-lb">
				...
				<view class="vip-lb-da">
					<input disabled class="vip-lb-input uni-input" cursor-spacing = "10" type="text" value="" placeholder="输入用户名称" v-model="retUserWhatCall" @input="comNameInput" />
				</view>
			</view>
			<view class="vip-lb">
				...
				<view class="vip-lb-da">
					<picker disabled  :value="index" :range="array">
						<view class="uni-input">{{ retUser.industry||array[index] }}</view>
					</picker>
				</view>
			</view>
			<view class="vip-lb">
...
export default {
	...
	methods: {
		...
		bindPickerChange: function(e) {
			...
			this.retUser.industry=this.array[e.target.value];
		},
		// aNav(){
		// 	uni.navigateTo({
